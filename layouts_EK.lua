...
function layouts:Default() 
	local layout = {
		['anchor'] = {
			['x'] = 730, --Horizontal position from UIParent, BOTTOMLEFT
			['y'] = 200, --Vertical position from UIParent, BOTTOMLEFT
		},
		...
		['frame'] = {
			['width'] = 90, --Unit frame width
			['height'] = 45,--Unit frame height
			['vspacing'] = 4, -- Vertical Spacing
			['hspacing'] = 4, -- Horizontal Spacing
		...
		['icon'] = {
			...
			['durationFont'] = STANDARD_TEXT_FONT, --duration text font
			['durationEnabled'] = true, -- Enable duration text
			['durationSize'] = 14, --name/cast text size
			...
			['stackFont'] = STANDARD_TEXT_FONT, --Stack text font
			...
			['flashEnabled'] = false, --Enable icon flashing
			['flashTimer'] = 3, --Flash at <X (seconds)
			['flashSpeed'] = 1, --Flash speed (seconds)
		},
		['raidIcon'] = {
			['size'] = 24, --Raid icon size
			['pos'] = 'CENTER', --Raid icon position
			['x'] = 0, --Raid icon horizontal position
			['y'] = 0, --Raid icon vertical position
		},
		['text'] = { -- Name/Cast text
			['pos'] = 'BOTTOMRIGHT', --name/cast text anchor
			['size'] = 14, --name/cast text size
			['font'] = STANDARD_TEXT_FONT, --name/cast text font
		...
		['healthText'] = { -- Health text
			['enabled'] = false, -- Enable health text
			['pos'] = 'TOPRIGHT', --name/cast text anchor
			['size'] = 14, --name/cast text size
			['font'] = STANDARD_TEXT_FONT, --name/cast text font
			['x'] = -2, --name/cast text horizontal position
			['y'] = -2, --name/cast text vertical position
		...
		['castBar'] = {
			...
			['detached_text_x'] = 0,
			['detached_text_y'] = 0,
			['detached_text_size'] = 14,
			['detached_text_font'] = STANDARD_TEXT_FONT,
